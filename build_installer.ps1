...
$workspacePath = "c:\Users\hanky\OneDrive\Desktop\project\LocalAI"
...
Write-Host "Reading and Base64-encoding source assets..." -ForegroundColor Cyan
$portableBytes = [System.IO.File]::ReadAllBytes($portablePath)
$portableBase64 = [System.Convert]::ToBase64String($portableBytes)

$serverBytes = [System.IO.File]::ReadAllBytes($serverPath)
$serverBase64 = [System.Convert]::ToBase64String($serverBytes)

Write-Host "Compiling assets into unified run.ps1..." -ForegroundColor Cyan

# Pure PowerShell Launcher template
$hybridTemplate = @"
# ==========================================================================
